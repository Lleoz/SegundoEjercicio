...
namespace Ejercicio2.Api.Transversal.Common.Tools
{
    public static class StringTool
    {
        ...
        public static string GetRandomString(int length = 10)
        {
            if (length < 1)
            {
                throw new ArgumentException("lenght must be number greater than 0");
            }
            ...
            for (int i = 0; i < password.Length; i++)
            {
                ...
                {
                    nextLeftGroupsOrderIdx = random.Next(
                        minValue: 0,
                        maxValue: lastLeftGroupsOrderIdx);
                }
                ...
                {
                    nextCharIdx = random.Next(
                        minValue: 0, 
                        maxValue: lastCharIdx + 1);
                }
